from Direccional.Direccional import Direccional
from Tuberia.Exterior import *
from Tuberia.Interior import *
from Hidraulica.SeccionesAnulares import *
from Hidraulica.Metodos.PlasticoBingham import *


dir = Direccional.creaJ(1500, 1.5, 30, 5000)
