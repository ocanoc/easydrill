...
class SwitchButton(QtWidgets.QWidget):
    def __init__(self, parent=None, w1="", l1=2, w2=" ", l2=60, width=75):
...
class Background(QtWidgets.QWidget):
    ...
    def paintEvent(self, event):
        ...
        if self.__enabled:
            qp.setBrush(QtGui.QColor(0, 80, 85))
            qp.drawRoundedRect(0, 0, s.width(), s.height(), 10, 10)

            lg = QtGui.QLinearGradient(0, 80, 85, 0)
            lg.setColorAt(0, QtGui.QColor(0, 80, 85))
            lg.setColorAt(0.35, QtGui.QColor(0, 90, 95))
            lg.setColorAt(0.85, QtGui.QColor(0, 80, 85))
            qp.setBrush(lg)
